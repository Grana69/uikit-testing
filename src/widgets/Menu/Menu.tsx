...
const Menu: React.FC<NavProps> = ({
  ...
  return (
    <Wrapper>
      ...
      <Alert>
      BETA VERSION. CONTRACTS BEEING AUDITED. USE AT YOUR OWN RISK. FARMS AND STAKING WILL BE ACTIVE SOON. STAY TUNED. BETA VERSION. CONTRACTS BEEING AUDITED. USE AT YOUR OWN RISK.
      </Alert>
      <SubNavContainer>
      <ConnectContainer>
          <Logo
